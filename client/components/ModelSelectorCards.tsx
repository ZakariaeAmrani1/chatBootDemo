...
const models: ModelOption[] = [
  {
    id: "gpt-4",
    name: "GPT-4",
    description: "Most capable model with superior reasoning and complex task handling",
  ...
  },
  {
    id: "claude-3",
    name: "Claude 3",
    description: "Anthropic's latest with excellent coding and analysis capabilities",
            ...
            >
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  <Icon className={cn("w-5 h-5", isSelected ? model.color : "text-muted-foreground")} />
                  <h3 className={cn("font-semibold", isSelected ? model.color : "text-foreground")}>
                    {model.name}
                  </h3>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  {isSelected && (
                    <div className={cn("w-5 h-5 rounded-full flex items-center justify-center", model.bgColor)}>
